...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    timeline: [
      { time: "6:30 AM", activity: "Early breakfast at Coyote Mountain Lodge", notes: "Pack snacks, water, and picnic lunch. Enter RMNP before 9 AM to beat crowds" },
      { time: "7:00 AM", activity: "Leave Coyote Mountain Lodge for Bear Lake", notes: "~43 min drive directly to Bear Lake via US-36 W and Bear Lake Rd. GO DIRECT — don't stop at visitor center yet, beat the parking rush" },
      { time: "7:45 AM", activity: "Bear Lake", notes: "Easy 0.6-mile loop. Stunning mountain reflections. Perfect for Aria. PARKING FILLS BY 8 AM — you made it!", mapUrl: "https://maps.google.com/?q=Bear+Lake,+Rocky+Mountain+National+Park,+Estes+Park,+CO", pricing: "Park $30/vehicle + Timed Entry $2" },
      { time: "8:30 AM", activity: "Drive to Sprague Lake", notes: "~5 min drive from Bear Lake (same road)" },
      { time: "8:45 AM", activity: "Sprague Lake", notes: "Flat 0.8-mile loop, stroller accessible, incredible views. Elk often spotted here", mapUrl: "https://maps.google.com/?q=Sprague+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "10:00 AM", activity: "Drive Trail Ridge Road up to Forest Canyon Pass", notes: "Highest continuous paved road in US (12,185ft). ~30 min drive up. Stop at viewpoints. Watch for altitude symptoms in Aria above 10,000ft", mapUrl: "https://maps.google.com/?q=Trail+Ridge+Road,+Rocky+Mountain+National+Park,+CO" },
      { time: "11:30 AM", activity: "Drive back down Trail Ridge Road", notes: "Stop at Many Parks Curve Overlook for photos" },
      { time: "12:00 PM", activity: "Picnic lunch at Many Parks Curve Overlook", notes: "Enjoy the views", mapUrl: "https://maps.google.com/?q=Many+Parks+Curve+Overlook,+Rocky+Mountain+National+Park,+CO" },
      { time: "12:45 PM", activity: "Drive to Lily Lake", notes: "~25 min drive from Many Parks Curve" },
      { time: "1:15 PM", activity: "Lily Lake", notes: "Easy 0.8-mile flat loop. Beautiful lily pads, very kid-friendly. Different direction from Bear Lake (off CO-7)", mapUrl: "https://maps.google.com/?q=Lily+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "2:15 PM", activity: "Drive to Beaver Meadows Visitor Center", notes: "~15 min from Lily Lake. Stop on the way back to lodge" },
      { time: "2:30 PM", activity: "Beaver Meadows Visitor Center", notes: "RMNP main entrance. Get Junior Ranger booklet/badge for Aria! Park maps, exhibits, restrooms, gift shop. Validate Timed Entry Permit", mapUrl: "https://maps.google.com/?q=Beaver+Meadows+Visitor+Center,+1000+US+Highway+36,+Estes+Park,+CO+80517" },
      { time: "3:00 PM", activity: "Drive back to Coyote Mountain Lodge", notes: "~10 min from Visitor Center" },
      { time: "3:15 PM", activity: "Return to lodge, rest/pool time", notes: "Aria will be tired" },
      { time: "5:00 PM", activity: "Pack for tomorrow's early departure", notes: "Flight at 9:29 AM — need to leave lodge by 6:00 AM" },
      { time: "6:30 PM", activity: "Farewell dinner in Estes Park", notes: "Poppy's Pizza, Nepal's Cafe, or Rock Inn Mountain Tavern" },
    ],
    driving: "Lodge → Bear Lake (43 min) → Sprague Lake (5 min) → Trail Ridge (~30 min up) → Lily Lake (~25 min) → Visitor Center (~15 min) → Lodge (10 min)",
    totalDriving: "~2 hrs total driving",
    critical: "CRITICAL: You need a Timed Entry Permit! Book at recreation.gov — search 'Rocky Mountain National Park'. Bear Lake parking fills by 8 AM — go directly there first!",
