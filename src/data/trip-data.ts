...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    date: "August 3",
    dayName: "Monday",
    theme: "Full day in RMNP: the highlight (reservation-free evening)",
    location: "Estes Park (Coyote Mountain Lodge, 1340 Big Thompson Ave)",
    timeline: [
      { time: "10:00 AM", activity: "Late breakfast at Coyote Mountain Lodge", notes: "Pack snacks, water. Sunscreen, hats, layers for altitude" },
      ...
      { time: "12:15 PM", activity: "Drive to Indian Bites Estes Park", notes: "~10 min from Hermit Park" },
      { time: "12:30 PM", activity: "Lunch at Indian Bites Estes Park", notes: "Indian cuisine. Parcel dinner to-go for later tonight! Order extra for hotel dinner", mapUrl: "https://maps.google.com/?q=Indian+Bites+Estes+Park,+Colorado" },
      { time: "1:30 PM", activity: "Drive back to Coyote Mountain Lodge", notes: "~10 min drive. Rest and relax before evening park visit" },
      { time: "2:00 PM", activity: "Rest time at hotel", notes: "Aria nap time, pack dinner, freshen up. Recharge before evening RMNP visit" },
      { time: "4:00 PM", activity: "Leave lodge for RMNP", notes: "Drive to park entrance. General park accessible after 2 PM (no reservation)" },
      { time: "4:15 PM", activity: "Enter RMNP", notes: "Pay $30 park entrance fee. Head to Lily Lake first" },
      { time: "4:45 PM", activity: "Lily Lake", notes: "Easy 0.8-mile flat loop. Lily pads, mountain views, kid-friendly. Good warm-up before Bear Lake Road opens at 6 PM", mapUrl: "https://maps.google.com/?q=Lily+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "5:45 PM", activity: "Drive to Bear Lake Road entrance", notes: "Position yourself for 6 PM Bear Lake Road access" },
      { time: "6:00 PM", activity: "Enter Bear Lake Road corridor", notes: "No reservation needed after 6 PM! Access to Bear Lake, Sprague Lake, Moraine Park" },
      { time: "6:15 PM", activity: "Bear Lake", notes: "Iconic RMNP spot! Easy 0.6-mile loop. Stunning mountain reflections. Perfect for Aria. Beautiful evening light", mapUrl: "https://maps.google.com/?q=Bear+Lake,+Rocky+Mountain+National+Park,+Estes+Park,+CO" },
      { time: "7:00 PM", activity: "Sprague Lake", notes: "Flat 0.8-mile loop, stroller accessible. Great for sunset photos. Elk often spotted here in evening", mapUrl: "https://maps.google.com/?q=Sprague+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "7:45 PM", activity: "Moraine Park (elk viewing at dusk)", notes: "Famous elk meadow! Elk herds active at dusk. Aria will love seeing them up close. Best wildlife viewing of the trip!", mapUrl: "https://maps.google.com/?q=Moraine+Park,+Rocky+Mountain+National+Park,+CO" },
      { time: "8:15 PM", activity: "Sunset at Moraine Park", notes: "Golden hour magic. Best light of the day. Stay until ~8:30 PM" },
      { time: "8:30 PM", activity: "Drive back to Coyote Mountain Lodge", notes: "~10-15 min from park entrance" },
      { time: "8:45 PM", activity: "Return to lodge, Indian dinner (parceled)", notes: "Eat the dinner parceled from Indian Bites. Relax and pack" },
      { time: "9:30 PM", activity: "Pack for tomorrow's early departure", notes: "Flight at 9:29 AM — MUST leave by 6:00 AM tomorrow" },
    ],
    driving: "Lodge → Hermit Park (9 min) → Indian Bites (10 min) → Lodge (10 min) → RMNP Lily Lake (~15 min) → Bear Lake Road → Bear Lake → Sprague Lake → Moraine Park → Lodge (~10 min)",
    totalDriving: "~1.5 hrs total driving",
    critical: "NO RESERVATION NEEDED! Pre-2 PM: Hermit Park (outside RMNP). After 2 PM: Lily Lake accessible. After 6 PM: Bear Lake Road (Bear Lake, Sprague Lake, Moraine Park) opens. Indian dinner parceled for hotel.",
    rainPlan: "Afternoon thunderstorms common. If weather bad at 4 PM, extend hotel rest time. Evening Bear Lake Road visit may still be possible after 6 PM if storms clear.",
  },
  {
    day: 7,
    date: "August 4",
