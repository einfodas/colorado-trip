...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: "9:00 AM", activity: "Pack and load car", notes: "Check out by 11 AM (DoubleTree checkout time)" },
      { time: "10:00 AM", activity: "Checkout from DoubleTree Denver", notes: "Itinerary #73485184920880. Leave luggage at front desk if exploring before driving" },
      { time: "10:15 AM", activity: "Drive Denver → Estes Park", notes: "~1.5 hrs via I-25 N to US-34 W", mapUrl: "https://maps.google.com/?q=Estes+Park,+CO+80517" },
      { time: "11:45 AM", activity: "Arrive Estes Park, early lunch", notes: "Grab lunch before hotel check-in", mapUrl: "https://maps.google.com/?q=Downtown+Estes+Park,+CO+80517" },
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: "10:00 AM", activity: "Echo Lake", notes: "Quick stop: 0.5-mile loop, beautiful lake, beautiful mountain reflections. Very kid-friendly. Requires driving back to Estes Park then up CO 72 (Peak to Peak Highway) — ~35 min from Sprague Lake", mapUrl: "https://maps.google.com/?q=Echo+Lake,+Rocky+Mountain+National+Park,+CO" },
