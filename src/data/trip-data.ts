...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    timeline: [
      { time: "10:00 AM", activity: "Late breakfast at Coyote Mountain Lodge", notes: "Pack snacks, water, picnic lunch. Sunscreen, hats, layers for altitude" },
      { time: "10:30 AM", activity: "Leave Coyote Mountain Lodge for RMNP", notes: "~10 min drive to Visitor Center" },
      { time: "10:45 AM", activity: "Beaver Meadows Visitor Center", notes: "Get Junior Ranger booklet for Aria, park map, validate Timed Entry Permit, use restrooms. Ask about Bear Lake parking/shuttle status", mapUrl: "https://maps.google.com/?q=Beaver+Meadows+Visitor+Center,+1000+US+Highway+36,+Estes+Park,+CO+80517" },
      { time: "11:00 AM", activity: "Drive to Bear Lake / Park & Ride", notes: "~37 min drive. Parking WILL be full — plan to use free shuttle from Park & Ride (Bear Lake Road entrance)" },
      { time: "11:40 AM", activity: "Bear Lake (or shuttle to Bear Lake)", notes: "Easy 0.6-mile loop. Stunning mountain reflections. Iconic RMNP spot! Shuttle runs every 15-20 min", mapUrl: "https://maps.google.com/?q=Bear+Lake,+Rocky+Mountain+National+Park,+Estes+Park,+CO", pricing: "Park $30/vehicle + Timed Entry $2" },
      { time: "12:30 PM", activity: "Sprague Lake", notes: "5 min drive from Bear Lake. Flat 0.8-mile loop, stroller accessible, incredible views. Quick but worthwhile", mapUrl: "https://maps.google.com/?q=Sprague+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "1:15 PM", activity: "Drive Trail Ridge Road up", notes: "Highest continuous paved road in US! Climb from 7,500ft to 12,000ft. Stop at Rainbow Curve, Forest Canyon Overlook", mapUrl: "https://maps.google.com/?q=Trail+Ridge+Road,+Rocky+Mountain+National+Park,+CO" },
      { time: "2:00 PM", activity: "Alpine Visitor Center (11,796 ft)", notes: "Highest visitor center in NPS! Gift shop, snacks, restrooms, panoramic views. Eat lunch here with incredible backdrop", mapUrl: "https://maps.google.com/?q=Alpine+Visitor+Center,+Rocky+Mountain+National+Park,+CO" },
      { time: "2:30 PM", activity: "Picnic lunch at Alpine Visitor Center", notes: "Let Aria run around (carefully — altitude!). Views in every direction" },
      { time: "3:15 PM", activity: "Drive back down Trail Ridge Road", notes: "Stop at Many Parks Curve, Rainbow Curve for photos. Different views coming down" },
      { time: "4:15 PM", activity: "Lily Lake", notes: "~30 min from Trail Ridge. Easy 0.8-mile flat loop. Lily pads, mountain views, kid-friendly. Less crowded, perfect late afternoon", mapUrl: "https://maps.google.com/?q=Lily+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "5:00 PM", activity: "Moraine Park (elk viewing)", notes: "Famous elk meadow! Late afternoon = elk active and grazing. Aria will love seeing the herds up close. Drive through, photos, short walk", mapUrl: "https://maps.google.com/?q=Moraine+Park,+Rocky+Mountain+National+Park,+CO" },
      { time: "6:00 PM", activity: "Drive to Estes Park downtown", notes: "~15 min from Moraine Park" },
      { time: "6:15 PM", activity: "Dinner in Estes Park", notes: "Poppy's Pizza, Nepal's Cafe, or Rock Inn Mountain Tavern. Souvenir shops for Aria" },
      { time: "7:30 PM", activity: "Return to RMNP for sunset", notes: "Drive back into park for golden hour — best light of the day" },
      { time: "7:45 PM", activity: "Sunset at Sprague Lake or Bear Lake Road", notes: "Golden hour = best photos. Wildlife active at dusk. Views will be magical. Stay until ~8 PM", mapUrl: "https://maps.google.com/?q=Sprague+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "8:00 PM", activity: "Drive back to Coyote Mountain Lodge", notes: "~10-15 min from park entrance" },
      { time: "8:15 PM", activity: "Return to lodge, pack for early departure", notes: "Flight at 9:29 AM — MUST leave by 6:00 AM tomorrow" },
    ],
    driving: "Lodge → Visitor Center (10 min) → Bear Lake/Park & Ride (~37 min) → Sprague Lake (5 min) → Trail Ridge Road up (~45 min) → Alpine Visitor Center → Lily Lake (~30 min) → Moraine Park (~15 min) → Lodge (~10 min)",
    totalDriving: "~2.5 hrs total driving",
    critical: "CRITICAL: Timed Entry Permit required! Book at recreation.gov. Bear Lake parking WILL be full by 10:30 AM — use free shuttle from Park & Ride (Bear Lake Rd entrance). Shuttle runs every 15-20 min.",
