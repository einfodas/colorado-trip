...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    date: "August 3",
    dayName: "Monday",
    theme: "Full day in RMNP: the highlight (reservation-free afternoon/evening)",
    ...
    timeline: [
      ...
      { time: "2:00 PM", activity: "Enter RMNP (no reservation needed after 2 PM)", notes: "Pay $30 park entrance fee. Trail Ridge Road and general park now accessible without reservation!" },
      { time: "2:15 PM", activity: "Drive Trail Ridge Road up", notes: "Highest continuous paved road in US! Climb from 7,500ft to 12,000ft. Stop at Rainbow Curve, Forest Canyon Overlook", mapUrl: "https://maps.google.com/?q=Trail+Ridge+Road,+Rocky+Mountain+National+Park,+CO" },
      { time: "3:00 PM", activity: "Alpine Visitor Center (11,796 ft)", notes: "Highest visitor center in NPS! Gift shop, restrooms, panoramic views. Get Junior Ranger badge for Aria here!", mapUrl: "https://maps.google.com/?q=Alpine+Visitor+Center,+Rocky+Mountain+National+Park,+CO" },
      { time: "3:30 PM", activity: "Picnic lunch at Alpine Visitor Center", notes: "Eat with incredible views. Let Aria run around (carefully — altitude!)" },
      { time: "4:15 PM", activity: "Drive back down Trail Ridge Road", notes: "Stop at Many Parks Curve, Rainbow Curve for photos. Different views coming down" },
      { time: "5:00 PM", activity: "Drive to Lily Lake area", notes: "~30 min from Trail Ridge. Arrive before 6 PM Bear Lake Road opens" },
      { time: "5:30 PM", activity: "Lily Lake", notes: "Easy 0.8-mile flat loop. Lily pads, mountain views, kid-friendly. Quick stop before Bear Lake Road opens at 6 PM", mapUrl: "https://maps.google.com/?q=Lily+Lake,+Rocky+Mountain+National+Park,+CO" },
      { time: "6:00 PM", activity: "Drive to Bear Lake Road (no reservation needed after 6 PM)", notes: "Bear Lake Road corridor now open without reservation! Access to Bear Lake, Sprague Lake, Moraine Park" },
      { time: "6:15 PM", activity: "Bear Lake", notes: "Iconic RMNP spot! Easy 0.6-mile loop. Stunning mountain reflections. Perfect for Aria. Less crowded in evening", mapUrl: "https://maps.google.com/?q=Bear+Lake,+Rocky+Mountain+National+Park,+Estes+Park,+CO" },
      ...
      { time: "7:45 PM", activity: "Moraine Park (elk viewing at dusk)", notes: "Famous elk meadow! Elk herds active at dusk. Aria will love seeing them up close. Best wildlife viewing of the day", mapUrl: "https://maps.google.com/?q=Moraine+Park,+Rocky+Mountain+National+Park,+CO" },
      { time: "8:15 PM", activity: "Sunset at Moraine Park or Bear Lake Road", notes: "Golden hour magic. Stay until ~8:30 PM if weather good" },
