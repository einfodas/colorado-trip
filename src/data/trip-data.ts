...
export const itinerary: DayPlan[] = [
  ...
  },
  {
    ...
    timeline: [
      { time: "6:30 AM", activity: "Early breakfast at Coyote Mountain Lodge", notes: "Pack snacks and water. Enter RMNP before 9 AM to beat crowds" },
      { time: "7:00 AM", activity: "Leave Coyote Mountain Lodge for RMNP", notes: "~43 min drive to Bear Lake via US-36 W and Bear Lake Rd" },
      { time: "7:45 AM", activity: "Bear Lake", notes: "Easy 0.6-mile loop. Stunning mountain reflections. Perfect for Aria. PARKING FILLS BY 8 AM — arrive early!", mapUrl: "https://maps.google.com/?q=Bear+Lake,+Rocky+Mountain+National+Park,+Estes+Park,+CO", pricing: "Park $30/vehicle + Timed Entry $2" },
      ...
      { time: "12:00 PM", activity: "Picnic lunch at Many Parks Curve Overlook", notes: "Pack lunch from lodge or grab sandwiches in town", mapUrl: "https://maps.google.com/?q=Many+Parks+Curve+Overlook,+Rocky+Mountain+National+Park,+CO" },
      ...
      { time: "2:15 PM", activity: "Drive back to Coyote Mountain Lodge", notes: "~14 min from Lily Lake via CO-7 E" },
      { time: "2:30 PM", activity: "Return to lodge, rest/pool time", notes: "Aria will be tired" },
    ...
    driving: "Coyote Mountain Lodge → Bear Lake (43 min) → Sprague Lake (5 min) → Trail Ridge Road up (~30 min) → Many Parks Curve → Lily Lake (~25 min) → Lodge (14 min)",
    totalDriving: "~2 hrs total driving",
    critical: "CRITICAL: You need a Timed Entry Permit! Book at recreation.gov — search 'Rocky Mountain National Park'. Bear Lake parking fills by 8 AM on weekends.",
