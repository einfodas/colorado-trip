...
export default function TripCalendar() {
  ...
  return (
    <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-7 md:gap-3">
      {itinerary.map((day) => (
        <button
          key={day.day}
          onClick={() => handleClick(day.day)}
          className="card min-w-[140px] snap-center p-3 text-left flex-shrink-0 hover:border-blue-300 transition-colors md:min-w-0"
        >
