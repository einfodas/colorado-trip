  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="card p-4 md:p-6">
        <h3 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-4">Elevation & Risk Levels</h3>
              ...
              <div key={d.location}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-stone-500 dark:text-stone-400">{d.elevation}</span>
      ...
      <div className="card p-4 md:p-6">
        <h3 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">Symptoms of Altitude Sickness</h3>
      ...
      <div className="card p-4 md:p-6 border-amber-200 dark:border-amber-800 transition-colors">
        <h3 className="text-lg font-semibold text-amber-800 dark:text-amber-400 mb-3">Watch for Aria</h3>
      ...
      <div className="card p-4 md:p-6">
        <h3 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-3">Prevention Steps</h3>
      ...
      <div className="card p-4 md:p-6 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800 transition-colors">
        <h3 className="text-lg font-semibold text-red-800 dark:text-red-400 mb-3">Descend Immediately If:</h3>
