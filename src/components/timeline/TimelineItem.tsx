  ...
  return (
    <div className="flex gap-3">
      <div className="flex flex-col items-center">
        <div className="w-3 h-3 rounded-full bg-blue-700 mt-1.5 flex-shrink-0" />
      ...
      <div className="flex-1 pb-4">
        ...
        <p className="text-base font-medium text-stone-900 mt-1">{item.activity}</p>
        {item.notes && (
          <p className="text-sm text-stone-600 mt-0.5">{item.notes}</p>
        )}
      </div>
    </div>
  );
